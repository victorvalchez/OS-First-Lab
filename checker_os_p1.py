...
def testExerciseCAT(folder):
	...
	print ("MYCAT CHECKER. Expected output:")
	print (result1.decode('ascii'))
	print ("MYCAT CHECKER. Program output:") 
	print (result2.decode('ascii'))

	if result1 == result2:
		print ("MYCAT CHECKER. CORRECT TEST")
		resultString += "1 " 
		result += 1.11112
	else:
		print ("MYCAT CHECKER. INCORRECT TEST. Outputs differ")
		resultString += "0 "
...
def testExerciseSIZE(folder):
	...
	#Comparamos las salidas e imprimimos resultados
	print ("MYSIZE CHECKER. Expected output:" )
	print (result1.decode('ascii'))
	print ("MYSIZE CHECKER. Program output:" )
	print (result2.decode('ascii'))

	if result1 == result2:
		print ("MYSIZE CHECKER. CORRECT TEST")
		resultString += "1 "
		result += 1.11112
	else:
		print ("MYSIZE CHECKER. INCORRECT TEST. Outputs differ")
		resultString += "0 "
